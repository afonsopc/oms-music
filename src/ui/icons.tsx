/**
 * Self-contained icon set (no icon package is installed). Lucide-style
 * 24x24 stroke glyphs inlined as SVG data URIs and rendered through
 * expo-image. Colors are baked into the SVG string; URIs are memoized per
 * (name, color, filled) so list rows never rebuild strings.
 */
