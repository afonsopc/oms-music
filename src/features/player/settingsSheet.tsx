 ...
 *
 *  - playback rate 0.5..1.5, com o interruptor do FR-64 por baixo: por
 *    omissão a velocidade arrasta o tom (varispeed), ligado o tom fica;
    ...
    <>
      ...
      <Section title={t(`${K}.speed`)}>
        ...
        {/* O interruptor do FR-64. Vai ao motor DIRECTAMENTE, como o
            temporizador: o rate viaja pelo cabo para o dispositivo activo, mas
            o algoritmo com que ESTE aparelho estica o áudio é dele e de mais
            ninguém. */}
        <View style={{ flexDirection: "row", gap: 8, flexWrap: "wrap", marginTop: 12 }}>
          <Chip
            label={t(`${K}.preservePitch`)}
            selected={pitchCorrection}
            disabled={localDisabled}
            onPress={() => getPlayerEngine().setPitchCorrection(!pitchCorrection)}
          />
        </View>
